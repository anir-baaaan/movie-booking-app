...
public class BookingDetailsScreen extends Screen
{
    ...
    public BookingDetailsScreen()
    {
        ...
        headingLabel = new Label(
                "Pssht... Your Booking Has Been Confirmed!",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.HEADING_FONT_SMALLER
        );
        ...
        // Detail Labels
        Label bookDetailsLabel = new Label("Booking Confirmed! Don't forget your popcorn. Details below:",
                Visuals.Colors.TEXT_NORMAL, Visuals.Fonts.SUBTITLE_FONT);
        ...
        movieDetailsPanel.add(posterLabel, new GridBagSettings(0, 0, 0, 1, GridBagSettings.VERTICAL,
                new Insets(0, 0, 0, 5)));
        movieDetailsPanel.add(detailsPanel, new GridBagSettings(1, 0, 1, 1, GridBagSettings.BOTH,
                new Insets(0, 30, 0, 0)));

        detailsPanel.add(bookDetailsLabel, new GridBagSettings(0, 0, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 0, 20, 0)));
        detailsPanel.add(nameLabel, new GridBagSettings(0, 1, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 0, 4, 0)));
        detailsPanel.add(hallAndRoomLabel, new GridBagSettings(0, 2, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 0, 4, 0)));
        detailsPanel.add(dateLabel, new GridBagSettings(0, 3, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 0, 4, 0)));
        detailsPanel.add(timeLabel, new GridBagSettings(0, 4, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 0, 4, 0)));
        detailsPanel.add(seatsLabel, new GridBagSettings(0, 5, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 0, 4, 0)));

        add(headingLabel, new GridBagSettings(0, 0, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(25, 20, 10, 20)));
        add(movieDetailsPanel, new GridBagSettings(0, 1, 1, 1, GridBagSettings.BOTH,
                new Insets(0, 20, 0, 20)));
        add(okButton, new GridBagSettings(0, 2, 1, 1, GridBagSettings.BOTH,
    ...
    {
        headingLabel.setText("Pssht, " +
                AccountsManager.currentAccount.holderName.trim().split(" ")[0] +
                "... Your Ticket(s) Have Been Confirmed!");
