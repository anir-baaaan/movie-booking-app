...
public class SeatsSelectScreen extends Screen
{
    ...
    public void PopulateSeats(Movie movie, CinemaHall hall, Date date, int timeIndex)
    {
        ...
        Label frontRowLabel = new Label("Front Rows ($" + hall.frontRowCost + ")",
                Visuals.Colors.TEXT_NORMAL, Visuals.Fonts.NORMAL_FONT);
        Label normalRowLabel = new Label("Normal Rows ($" + hall.normalRowCost+ ")",
                Visuals.Colors.TEXT_NORMAL, Visuals.Fonts.NORMAL_FONT);
        Label premiumRowLabel = new Label("Premium Rows ($" + hall.premiumRowCost + ")",
                Visuals.Colors.TEXT_NORMAL, Visuals.Fonts.NORMAL_FONT);
